...
define(function (require) {
    ...
    ret.getGridData = function () {
        ...
        return [
            {
                Id: 11, aaaa: 'zbc', bbbb: '企业一部', cccc: '所有数据', dddd: '机密', eeee: '增删改查', ffff: '增删改查', gggg: '增删改查', hhhh: '增删改查', iiii: '增删改查', jjjj: '增删改查', kkkk: '增删改查', llll: '增删改查', mmmm: '增删改查', nnnn: '增删改查', oooo: '增删改查',
