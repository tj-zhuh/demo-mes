...
define(function (require) {
    ...
    ret.getGridData = function () {
        ...
        return [
            {
                Id: 11, aaaa: '1', bbbb: 'GT6788', cccc: '操作不当', dddd: '13', eeee: '无', ffff: '增删改查', gggg: '增删改查', hhhh: '增删改查', iiii: '增删改查', jjjj: '增删改查', kkkk: '增删改查', llll: '增删改查', mmmm: '增删改查', nnnn: '增删改查', oooo: '增删改查',
                ecolor: 'red', fcolor: 'red', gcolor: 'yellow', hcolor: 'green', icolor: 'red', jcolor: 'blue', kcolor: 'red', lcolor: 'red', mcolor: 'red'
            }, {
                Id: 11, aaaa: '2', bbbb: 'GT6677', cccc: '操作不当', dddd: '12', eeee: '无', ffff: '增删改查', gggg: '增删改查', hhhh: '增删改查', iiii: '增删改查', jjjj: '增删改查', kkkk: '增删改查', llll: '增删改查', mmmm: '增删改查', nnnn: '增删改查', oooo: '增删改查',
                ecolor: 'red', fcolor: 'red', gcolor: 'green', hcolor: 'green', icolor: 'green', jcolor: 'blue', kcolor: 'red', lcolor: 'blue', mcolor: 'red'
            }, {
                Id: 11, aaaa: '3', bbbb: 'GF8888', cccc: '操作不当', dddd: '1', eeee: '无', ffff: '增删改查', gggg: '增删改查', hhhh: '增删改查', iiii: '增删改查', jjjj: '增删改查', kkkk: '增删改查', llll: '增删改查', mmmm: '增删改查', nnnn: '增删改查', oooo: '增删改查',
