...
define(function (require) {
    ...
    ret.getGridData = function () {
        ...
        return [
            { Id: 11, aaaa: '管理员', bbbb: '10', cccc: '所有数据', dddd: '机密', eeee: '增删改查' },
            { Id: 12, aaaa: '操作员', bbbb: '100', cccc: '所有数据', dddd: '机密', eeee: '增删改查' },
            { Id: 13, aaaa: '技术员', bbbb: '200', cccc: '所有数据', dddd: '机密', eeee: '增删改查' }
